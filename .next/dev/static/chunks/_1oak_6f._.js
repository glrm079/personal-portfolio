    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Portfolio.useEffect": ()=>{
            const closeMenuOnEscape = {
                "Portfolio.useEffect.closeMenuOnEscape": (event)=>{
                    if (event.key === 'Escape' && isMenuOpen) {
                        setIsMenuOpen(false);
                        menuButtonRef.current?.focus();
                    }
                }
            }["Portfolio.useEffect.closeMenuOnEscape"];
            window.addEventListener('keydown', closeMenuOnEscape);
            return ({
                "Portfolio.useEffect": ()=>window.removeEventListener('keydown', closeMenuOnEscape)
            })["Portfolio.useEffect"];
        }
    }["Portfolio.useEffect"], [
        isMenuOpen
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Portfolio.useEffect": ()=>{
            const updateHeaderState = {
                "Portfolio.useEffect.updateHeaderState": ()=>setHasScrolled(window.scrollY > 12)
            }["Portfolio.useEffect.updateHeaderState"];
            updateHeaderState();
            window.addEventListener('scroll', updateHeaderState, {
                passive: true
            });
            return ({
                "Portfolio.useEffect": ()=>window.removeEventListener('scroll', updateHeaderState)
            })["Portfolio.useEffect"];
        }
    }["Portfolio.useEffect"], []);
...
_s(Portfolio, "OLioQMcQ6XwTCrYsPlNxR9y+7Es=", false, function() {
    return [
...
//# sourceMappingURL=_1oak_6f._.js.map