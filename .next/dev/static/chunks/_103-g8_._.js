...
const fragmentShader = `
  ...
  void main() {
    ...
    float cursorDistance = length(cursorDirection);
    float cursor = exp(-10.0 * dot(cursorDirection, cursorDirection));
    float ripple = sin(cursorDistance * 46.0 - uTime * 8.0) * exp(-5.5 * cursorDistance) * uImpulse;
    flow += normalize(cursorDirection + .0001) * cursor * uInteractive * (.82 + uImpulse * .55);
    flow += uVelocity * cursor * uInteractive * 3.2;
    float field = fbm(uv * 1.8 + flow * 2.7 + uTime * .025);
    field += cursor * uInteractive * (.65 + .22 * sin(uTime * 2.0 + field * 12.0)) + ripple * .48;
    float liquid = smoothstep(.28, .78, field);
    float highlight = smoothstep(.62, .95, field) * .13;
    vec3 color = mix(uBase, uFluid, liquid * .42);
    color += highlight;
...
function LiquidEtherBackground() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LiquidEtherBackground.useEffect": ()=>{
            ...
            const uniforms = {
                ...
                uInteractive: {
                    value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$liquid$2d$ether$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLiquidEtherSettings"])(window.innerWidth).interactive ? 1 : 0
                },
                uImpulse: {
                    value: 0
                },
            ...
            const resize = {
                "LiquidEtherBackground.useEffect.resize": ()=>{
                    ...
                    renderer.setPixelRatio(Math.min(window.devicePixelRatio, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$liquid$2d$ether$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLiquidEtherSettings"])(window.innerWidth).maxPixelRatio));
            ...
            const move = {
                "LiquidEtherBackground.useEffect.move": (event)=>{
                    ...
                    uniforms.uImpulse.value = Math.min(1, uniforms.uVelocity.value.length() * 18 + .25);
                    previousPointer.copy(nextPointer);
                    uniforms.uMouse.value.copy(nextPointer);
                    const cursorLayer = cursorRef.current;
                    if (cursorLayer) {
                        cursorLayer.style.left = `${event.clientX}px`;
                        cursorLayer.style.top = `${event.clientY}px`;
                        cursorLayer.style.opacity = '1';
                        cursorLayer.style.transform = `translate(-50%, -50%) scale(${1 + uniforms.uImpulse.value * .28})`;
                    }
                }
            ...
            const render = {
                "LiquidEtherBackground.useEffect.render": (time)=>{
                    ...
                    uniforms.uImpulse.value *= .94;
                    uniforms.uVelocity.value.multiplyScalar(.94);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ref: cursorRef,
            className: "absolute size-[42vmax] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-0 transition-[opacity,transform] duration-150 bg-[radial-gradient(circle,rgba(0,0,0,.24)_0%,rgba(0,0,0,.08)_32%,transparent_68%)] mix-blend-multiply dark:bg-[radial-gradient(circle,rgba(255,255,255,.32)_0%,rgba(255,255,255,.1)_32%,transparent_68%)] dark:mix-blend-screen",
            style: {
                zIndex: 1
            }
        }, void 0, false, {
...
_s(LiquidEtherBackground, "UfV+pk2MopCWvedQkPzEF+aSd2c=", false, function() {
    return [
...
//# sourceMappingURL=_103-g8_._.js.map